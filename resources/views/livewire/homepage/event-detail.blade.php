<div>
    ...
    <section class="relative h-[80vh] flex items-center justify-center text-center overflow-hidden bg-slate-900">
        ...
        <div class="container mx-auto px-6 z-10">
            <div class="max-w-4xl mx-auto">
                ...
                {{-- Author & Date Info --}}
                <div
                    class="flex flex-wrap justify-center items-center gap-6 text-white/90 animate-fade-in-up delay-200">
            ...
            <div class="flex flex-col lg:flex-row gap-16">
                ...
                <div class="lg:w-2/3 space-y-12">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div
                            class="p-8 bg-slate-50 rounded-4xl border border-slate-100 group hover:border-ksc-blue/20 transition-colors">
                            <div
                                class="w-12 h-12 bg-ksc-blue/10 rounded-2xl flex items-center justify-center text-ksc-blue mb-6 group-hover:scale-110 transition-transform">
                        ...
                        <div
                            class="p-8 bg-slate-50 rounded-4xl border border-slate-100 group hover:border-ksc-accent/20 transition-colors">
                            <div
                                class="w-12 h-12 bg-ksc-accent/10 rounded-2xl flex items-center justify-center text-ksc-accent mb-6 group-hover:scale-110 transition-transform">
                                <x-lucide-clock class="w-6 h-6" />
                            </div>
                            <h3 class="text-xl font-black text-slate-900 mb-2 uppercase italic">Waktu Pelaksanaan</h3>
                            <p class="text-slate-600 font-bold">Pukul
                                {{ \Carbon\Carbon::parse($event['waktu_event'])->format('H:i') }} WIB - Selesai</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:w-1/3">
                    <div class="sticky top-32">
                        <div
                            class="bg-white rounded-[3rem] border border-slate-100 shadow-2xl shadow-slate-200/50 overflow-hidden p-8 md:p-10 ring-1 ring-slate-100">
                            <div class="space-y-4 mb-8">
                                <div
                                    ...
                                    <div class="text-sm">
                                        ...
                                        <p class="text-slate-500 font-bold tracking-tight">Kuota Maksimal
                                            {{ $event['total_quota'] }} Peserta</p>
                                    </div>
                                </div>
                                <div
                                    class="flex items-center gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                    ...
                                    <div class="text-sm">
                                        ...
                                        <p class="text-slate-500 font-bold tracking-tight">Untuk semua pemenang lomba
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                @if (session()->has('success'))
                                    <div
                                        class="p-4 bg-emerald-50 text-emerald-700 rounded-2xl text-sm font-bold flex items-center gap-2 border border-emerald-100 animate-fade-in">
                                ...
                                @if (session()->has('error'))
                                    <div
                                        class="p-4 bg-rose-50 text-rose-700 rounded-2xl text-sm font-bold flex items-center gap-2 border border-rose-100 animate-fade-in">
                                ...
                                @if ($event['status_event'] == 'berjalan')
                                    @if ($user)
                                        ...
                                        @if ($regCount > 0)
                                            <div
                                                class="p-4 bg-emerald-50 text-emerald-700 rounded-2xl text-[10px] font-black flex items-center justify-center gap-2 border border-emerald-100 mb-4 uppercase tracking-widest italic">
                                                <x-lucide-check-circle class="w-4 h-4" /> Anda sudah terdaftar di
                                                {{ $regCount }} kategori
                                            </div>
                                        @endif
                                        ...
                                        @can('master-pendaftaran.create.self')
                                            <button wire:click="closeCreateModal"
                                                ...
                                                {{ $regCount > 0 ? 'DAFTAR LAGI / TAMBAH LOMBA' : 'DAFTAR SEKARANG' }}
                                                <x-lucide-arrow-right class="w-5 h-5" />
                                            </button>
                                        @else
                                            <div
                                                class="w-full py-5 bg-amber-50 text-amber-700 rounded-2xl font-bold flex items-center justify-center gap-2 border border-amber-100 text-xs text-center px-4">
                                    ...
                                    @else
                                        <div class="space-y-3">
                                            ...
                                            <p
                                                class="text-[9px] text-center text-slate-400 font-bold uppercase tracking-widest italic">
                                                Belum punya akun? <a href="{{ route('register') }}"
                                                    class="text-ksc-blue underline">Daftar Member</a>
                                            </p>
                                        </div>
                                    @endif
        ...
        <div class="fixed inset-0 z-[200] overflow-y-auto px-4 py-6 sm:px-0 flex items-center justify-center">
            ...
            <div
                ...
                <div class="p-8 border-b border-slate-50 flex justify-between items-center bg-slate-50/30">
                    <h3 class="text-xl font-black text-slate-900 tracking-tighter uppercase italic">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-8 flex justify-start">
                                    <a href="{{ route('dashboard') }}"
                                        class="inline-flex items-center gap-2 px-6 py-3 bg-rose-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-rose-700 transition shadow-lg shadow-rose-200">
                    ...
                    @if (auth()->user()->can('master-pendaftaran.create'))
                        <div>
                            ...
                            <div class="space-y-3 p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                                ...
                                <div class="space-y-2 pr-2 overflow-y-auto custom-scrollbar"
                            ...
                            <div>
                                ...
                                <p class="text-[10px] font-bold text-blue-400 uppercase tracking-widest mt-1">Anda
                                    mendaftar sebagai: <span
                                        class="text-blue-600 font-black italic">{{ auth()->user()->profile?->full_name ?: auth()->user()->username }}</span>
                                </p>
                            </div>
                        </div>
                    @endif
                                        ...
                                        @foreach ($cats as $cat)
                                            ...
                                            <label
                                                ...
                                                <div class="text-right">
                                                    <p
                                                        class="text-sm font-black {{ $cat->type === 'paid' ? 'text-slate-900' : 'text-emerald-500' }} italic tracking-tighter">
                                                        @if ($cat->type === 'paid')
                                                    ...
                                                    @if ($isRegistered)
                                                        <span
                                                            class="text-[9px] font-black text-emerald-500 uppercase tracking-widest">Terdaftar</span>
                                                    @endif
                                                </div>
                                            </label>
                                        @endforeach
                                                    ...
                                                    <div
                                                        ...
                                                        @if ($event['qr_code'])
                                                            <div
                                                                ...
                                                                <a href="{{ asset($event['qr_code']) }}"
                                                                    target="_blank"
                                                                    class="group relative block cursor-zoom-in"
                                                                    title="Klik untuk memperbesar">
                                                                    <img src="{{ asset($event['qr_code']) }}"
                                                        ...
                                                        <div class="p-5 flex items-center justify-between gap-4">
                                                            <div class="flex-1 min-w-0">
                                                                ...
                                                                <p
                                                                    ...
                                                                    {{ $event['rekening'] }}</p>
                                                                <p
                                                                    class="text-[11px] font-bold text-amber-600 uppercase tracking-tight italic">
                                                                    a/n {{ $event['atas_nama'] }}</p>
                                                            </div>
                                                            <button type="button"
                ...
                <div class="p-8 border-t border-slate-50 flex justify-end gap-3 bg-slate-50/30">
                    ...
                    <button type="button" wire:click="saveManualRegistration"
                        wire:loading.attr="disabled" wire:target="saveManualRegistration, create_payment_proof"
                        ...
                        <span wire:loading.remove wire:target="saveManualRegistration, create_payment_proof">Simpan
                            Pendaftaran</span>
                        <span wire:loading wire:target="saveManualRegistration, create_payment_proof"
    ...
    <div id="share-modal" tabindex="-1" aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-[300] justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div
                class="relative bg-white rounded-[3rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.14)] border border-slate-100 overflow-hidden">
                {{-- Decorative Background Element --}}
                <div class="absolute top-0 right-0 -mr-16 -mt-16 w-48 h-48 bg-ksc-blue/5 rounded-full blur-3xl"></div>
                <div class="absolute bottom-0 left-0 -ml-16 -mb-16 w-48 h-48 bg-ksc-accent/5 rounded-full blur-3xl">
                </div>
                ...
                <div class="relative flex items-center justify-between p-8 pb-4">
                    <div>
                        ...
                        <p class="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-1">Ajak temanmu
                            untuk ikut serta!</p>
                    </div>
                    <button type="button"
                        class="text-slate-400 bg-slate-50 hover:bg-slate-100 hover:text-slate-900 rounded-2xl text-sm w-12 h-12 inline-flex justify-center items-center transition-all duration-300"
                ...
                <div class="relative p-8 pt-4">
                    <div
                        class="bg-slate-50/80 backdrop-blur-sm rounded-3xl p-5 mb-8 border border-slate-100/50 shadow-inner">
                        <p
                            class="text-[9px] text-slate-400 font-black uppercase tracking-widest mb-1.5 flex items-center gap-2">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-8">
                        <a href="https://api.whatsapp.com/send?text=Ayo ikut event {{ urlencode($event['nama_event']) }}! Cek detailnya di sini: {{ urlencode(url()->current()) }}"
                            ...
                            <div
                                class="w-14 h-14 bg-emerald-500 text-white rounded-2xl flex items-center justify-center shadow-xl shadow-emerald-200 group-hover:scale-110 group-active:scale-95 transition-all duration-300">
                                <i class="fab fa-whatsapp text-3xl"></i>
                            </div>
                            <span
                                class="text-[10px] font-black text-emerald-600 uppercase tracking-widest">WhatsApp</span>
                        </a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}"
                            ...
                            <div
                                class="w-14 h-14 bg-blue-600 text-white rounded-2xl flex items-center justify-center shadow-xl shadow-blue-200 group-hover:scale-110 group-active:scale-95 transition-all duration-300">
                                <i class="fab fa-facebook-f text-2xl"></i>
                            </div>
                            <span
                                class="text-[10px] font-black text-blue-600 uppercase tracking-widest">Facebook</span>
                        </a>
                    </div>
                    ...
                    <div x-data="{
                        ...
                        <label
                            class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 ml-2 flex items-center gap-2">
                            <x-lucide-link class="w-3 h-3" /> Tautan Langsung
                        </label>
                        <div
                            class="relative bg-slate-900 rounded-3xl p-2 pl-6 flex items-center justify-between shadow-2xl shadow-slate-200">
                            <div class="overflow-hidden">
                                <p class="text-[10px] font-bold text-slate-400 truncate pr-4" x-text="url"></p>
                            </div>
                            <button @click="copy()"
                                :class="copied ? 'bg-emerald-500 text-white shadow-emerald-200' :
                                ...
                                <template x-if="copied">
                                    <span class="flex items-center gap-2"><x-lucide-check class="w-3.5 h-3.5" />
                                        Tersalin!</span>
                                </template>
                            </button>
                        </div>
                ...
                <div class="p-8 pt-0 text-center">
                    <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest">© 2026 Khafid Swimming
                        Club</p>
                </div>
            </div>
        </div>
