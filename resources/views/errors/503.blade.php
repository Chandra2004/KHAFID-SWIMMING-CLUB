...
<head>
    ...
    <title>503 - Sistem Dalam Pemeliharaan | The Framework</title>
...
<body
    ...
    <div class="max-w-2xl w-full text-center space-y-12">
        ...
        <div class="space-y-4">
            ...
            <h1 class="text-5xl md:text-6xl font-black text-white glow-build tracking-tight italic uppercase">UNDER MAINTENANCE
            </h1>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="mailto:support@ksc.sidoarjo"
