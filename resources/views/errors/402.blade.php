...
<head>
    ...
    <title>402 - Pembayaran Diperlukan | The Framework</title>
...
<body
    ...
    <div class="max-w-2xl w-full text-center space-y-8">
        <div class="space-y-4">
            ...
            <h1 class="text-7xl font-black text-white glow-gold tracking-tighter">402</h1>
            <h2 class="text-3xl font-bold text-white tracking-tight">Pembayaran Diperlukan</h2>
            <p class="text-slate-400 text-lg leading-relaxed max-w-lg mx-auto">
                Maaf, akses ke halaman ini memerlukan pembayaran atau status langganan yang valid. Silakan selesaikan transaksi Anda untuk melanjutkan.
            </p>
        </div>
        ...
        <div class="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-6 backdrop-blur-sm max-w-md mx-auto">
            <div class="flex items-start gap-4 text-left">
                ...
                <div>
                    <h3 class="text-sm font-bold text-amber-100 mb-1">Status Transaksi</h3>
                    <p class="text-xs text-amber-200/60 leading-relaxed italic">
                        "{{ $message ?? 'Otorisasi pembayaran diperlukan untuk mengakses sumber daya ini.' }}"
                    </p>
                </div>
            </div>
        </div>
